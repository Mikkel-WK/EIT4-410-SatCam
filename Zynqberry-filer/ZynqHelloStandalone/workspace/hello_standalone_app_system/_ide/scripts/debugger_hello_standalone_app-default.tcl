...
# Path of this script: C:\School\Vivado\ZynqHelloStandalone\workspace\hello_standalone_app_system\_ide\scripts\debugger_hello_standalone_app-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\School\Vivado\ZynqHelloStandalone\workspace\hello_standalone_app_system\_ide\scripts\debugger_hello_standalone_app-default.tcl
# 
...
fpga -file C:/School/Vivado/ZynqHelloStandalone/workspace/hello_standalone_app/_ide/bitstream/main_wrapper.bit
targets -set -nocase -filter {name =~"APU*"}
