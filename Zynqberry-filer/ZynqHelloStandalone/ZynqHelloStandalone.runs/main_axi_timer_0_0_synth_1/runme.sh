...
HD_PWD='C:/School/Vivado/ZynqHelloStandalone/ZynqHelloStandalone.runs/main_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_axi_timer_0_0.tcl
