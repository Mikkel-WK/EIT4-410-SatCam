...
HD_PWD='C:/School/Vivado/ZynqHelloStandalone/ZynqHelloStandalone.runs/main_rst_ps7_0_49M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_rst_ps7_0_49M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_rst_ps7_0_49M_0.tcl
